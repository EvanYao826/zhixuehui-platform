...
public class PromptTemplate {
    ...
    static {
        // 课程推荐模板
        templates.put("course_recommendation", """
            你是一个专业的课程推荐助手，根据用户的学习历史和兴趣，推荐最适合的课程。
        ...
        // 管理端智能助手模板
        templates.put("admin_assistant", """
            你是一个教育平台的管理端智能助手，负责帮助管理员分析数据、生成报告和提供运营建议。
        ...
        templates.put("user_profile", """
            你是一个用户画像分析专家，根据用户的行为数据和学习记录，分析用户的学习习惯和偏好。
