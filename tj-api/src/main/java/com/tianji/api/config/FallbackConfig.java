...
public class FallbackConfig {
    ...
    @Bean
    public AiClientFallback aiClientFallback(){
        return new AiClientFallback();
    }

    @Bean
    public UserProfileClientFallback userProfileClientFallback(){
        return new UserProfileClientFallback();
    }
